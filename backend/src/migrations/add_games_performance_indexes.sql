...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_games_home_club_id
  ON games (home_club_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_games_away_club_id
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_games_home_team_id
  ON games (home_team_id)
  WHERE home_team_id IS NOT NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_games_away_team_id
